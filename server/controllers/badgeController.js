// server/controllers/badgesController.js
...
async function awardBadgeToUser(req, res) {
  try {
...
async function getBadgeLeaderboard(req, res) {
  try {
...
async function getBadgesByRarity(req, res) {
  try {
